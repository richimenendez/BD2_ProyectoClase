...
export default function Menu() {
    ...
    <Col><Cards title="Realizar Transferencia" dest ="/banks"  desc="Lista de Instituciones registradas en el servicio." img="https://communitybank.net/wp-content/uploads/2015/12/bank-icon.jpg"/></Col>
    </Row>
    <br></br>
    <Row> 
    ...
    <Col><Cards title="Creditos y Debitos por Banco" desc="Totales de los Debitos y Creditos de cada banco. Se incluyen también los listados." img="https://icon-library.com/images/wire_transfer-512.png"/></Col>
